...
# vendor.mokee.power@1.0 currently violates the artifact path requirements
# Exclude it from the check for now
_my_allowed_list += \
  $(TARGET_COPY_OUT_SYSTEM_EXT)/lib/vendor.mokee.power@1.0.so \
  $(TARGET_COPY_OUT_SYSTEM_EXT)/lib64/vendor.mokee.power@1.0.so \
