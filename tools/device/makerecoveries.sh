...
do
    ...
    DEVICE_NAME=$(echo $TARGET_PRODUCT | sed s/koush_// | sed s/zte_// | sed s/mk_// | sed s/aosp_// |  sed s/motorola// | sed s/huawei_// | sed s/htc_// | sed s/_us// | sed s/mokee_// | sed s/generic_// | sed s/full_//)
