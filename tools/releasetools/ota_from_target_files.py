...
""" % bcb_dev)
  ...
  if OPTIONS.backuptool:
    ...
    script.Mount("/system")
    script.RunBackup("backup", system_mount_point)
  ...
  if OPTIONS.backuptool:
    ...
    if is_system_as_root:
      script.fstab["/system"].mount_point = system_mount_point
    script.Mount("/system")
    script.RunBackup("restore", system_mount_point)
    script.Unmount(system_mount_point)
    if is_system_as_root:
      script.fstab["/system"].mount_point = "/"
...
""" % bcb_dev)
  ...
  input_zip_path = input_zip.filename
  common.ZipClose(input_zip)
  input_zip = zipfile.ZipFile(input_zip_path, "a")
