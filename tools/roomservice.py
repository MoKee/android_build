...
if not depsonly:
    githubreq = urllib.request.Request("https://api.github.com/search/repositories?q=%s+user:MoKee+in:name" % device)
    add_auth(githubreq)
...
def add_to_manifest(repositories, fallback_branch = None):
    ...
    for repository in repositories:
        ...
        project = ElementTree.Element("project", attrib = { "path": repo_target,
            "name": "MoKee/%s" % repo_name, "remote": "mokee" })
        ...
        if 'remote' in repository:
            ...
            if repository['remote'] == 'cyanogen' and not 'github' in repository['repository']:
